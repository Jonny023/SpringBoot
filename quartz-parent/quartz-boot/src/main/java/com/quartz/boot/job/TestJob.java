...
import com.quartz.boot.file.FileNameGenerator;
...
public class TestJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        try {
            log.info("------------------start------------------");
            FileNameGenerator fg = (FileNameGenerator) context.getJobDetail().getJobDataMap().get("fileNameGenerator");
            System.out.println(fg.generator());
            testService.hello();
